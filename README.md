...
- **Status Tracking**: Uses Metainformations from filenames to track successful backup operations across multiple sites. No extra separate status file required.
